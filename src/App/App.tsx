...
import {AppBar, Button, CircularProgress, Container, IconButton, Paper, Toolbar, Typography} from "@mui/material";
        ...
        <div className="App">
            <AppBar position="static">
                <Toolbar>
                    ...
                    {isLogin && <Button onClick={handleLogOut} color="inherit">Log Out</Button>}
                </Toolbar>
            </AppBar>
